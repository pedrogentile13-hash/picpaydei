...
const Components = (() => {
  ...
  function sidebar(activePage) {
    ...
    var menuItems = [
      ...
      { section: 'Lançamentos' },
      { id: 'negativos', label: 'Negativos', href: pagesPrefix + 'negativos.html', icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"/>' },
      { id: 'positivos', label: 'Positivos', href: pagesPrefix + 'positivos.html', icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>' },
      ...
      { id: 'pb', label: 'Prova Bimestral', href: pagesPrefix + 'pb.html', icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>' },
      { id: 'va', label: 'VA', href: pagesPrefix + 'va.html', icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>' },
    ...
    menuItems.forEach(function(item) {
      if (item.section) {
        // Section header
        navHTML += '<span class="nav-section">' + item.section + '</span>';
      } else {
        // Regular item
